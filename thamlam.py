...
class BaiToanTSPThamLam:
    def __init__(self, ma_tran_khoang_cach):
        """
        Khởi tạo lớp giải bài toán TSP bằng thuật toán Tham lam.
    ...
    def tim_duong_di(self, bat_dau_thanh_pho=0):
        """
        Tìm đường đi theo thuật toán Tham lam bắt đầu từ một thành phố cho trước.
            ...
            for thanh_pho_ke_tiep in range(self.so_thanh_pho):
                if not da_tham[thanh_pho_ke_tiep]:
                    ...
                    if khoang_cach < khoang_cach_nho_nhat:
                        ...
                        thanh_pho_tiep_theo = thanh_pho_ke_tiep

            if thanh_pho_tiep_theo != -1:
...
def main():
    """Hàm chính để chạy thuật toán Tham lam."""
    ...
    # Khởi tạo và chạy thuật toán Tham lam
    tham_lam = BaiToanTSPThamLam(ma_tran_khoang_cach=ma_tran_khoang_cach)

    bat_dau_thanh_pho = 0  # Chọn thành phố bắt đầu
    duong_di_tot_nhat, khoang_cach_tot_nhat = tham_lam.tim_duong_di(bat_dau_thanh_pho)
